  ...
  return (
    <section className="flex mx-28 my-20 gap-8 justify-center items-center">
      <div className="w-1/4">
        ...
        <ButtonAndIcon text={"Get Started"} icon={"src/assets/icons/RocketLaunch.png"}/>
      ...
      <div>
        <NFTCard cardImagePath={"src/assets/images/ImagePlaceholder.png"} title={"Space Walking"} avatarName={"Animakid"} avatarIconPath={"src/assets/images/Avatar.png"}/>
      </div>
    </section>
  );
}
